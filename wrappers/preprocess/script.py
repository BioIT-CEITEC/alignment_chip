...
trim_ends = ""
trim_ends = " --clip_R1 "+str(snakemake.params.trim_left1) if int(snakemake.params.trim_left1) > 0 else trim_ends
trim_ends = " --three_prime_clip_R1 "+str(snakemake.params.trim_right1) if int(snakemake.params.trim_right1) > 0 else trim_ends
max_length = " --max_length "+str(snakemake.params.crop)
if snakemake.params.paired:
    trim_ends = " --clip_R2 "+str(snakemake.params.trim_left2) if int(snakemake.params.trim_left2) > 0 else trim_ends
    trim_ends = " --three_prime_clip_R2 "+str(snakemake.params.trim_right2) if int(snakemake.params.trim_right2) > 0 else trim_ends
    max_length = ""
